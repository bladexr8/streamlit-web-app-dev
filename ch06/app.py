...
def main():
            ...
            if len(raw_text) == 0:
                ...
                with col1:
                    with st.expander("Basic Info"):
                        st.write("Text Stats")
                        # use neattext to generate states
    ...
    if choice == "Translation":
        ...
        if len(raw_text) < 3:
            ...
            if st.button("Translate"):
                translator = GoogleTranslator(source='auto', target=target_lang) # set source and target langugages
    ...
    if choice == "Sentiment Analysis":
        ...
        st.write("")
        st.write("")
        raw_text = st.text_area("Text to analyse", "Write something to be analysed...", height=200)
